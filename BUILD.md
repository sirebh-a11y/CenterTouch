...
- `--include-data-files=datum.png=datum.png`: include il disegno datum della schermata iniziale.
...
3. Non rinominare o spostare file asset prima della build: servono `logo777.ico`, `logo777_black on transparent.png`, `Wire-trading.png` e `datum.png`.
